...
const FormFieldRenderer = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-start gap-3 flex-1">
          <div className="flex items-center gap-2">
            <div className="cursor-move p-1 text-tacir-darkgray/60 hover:text-tacir-blue transition-colors">
      ...
      {/* Indicateur requis */}
      {field.required && (
        <div className="flex items-center gap-1 text-tacir-pink text-xs mt-2">
